...
Partially Implemented (M004 collection rules and `--rescan-deps` CLI flag pending)
...
| 2026-09-22 | Agent | Status → Partially Implemented — collection_health and dep_audit validators shipped |
