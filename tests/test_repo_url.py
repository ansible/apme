...
def test_normalize_repo_url_strips_git_suffix() -> None:
    assert (
        normalize_repo_url("https://github.com/acme-scm/amazon.aws.git")
...
def test_normalize_repo_url_lowercases_host() -> None:
    assert (
        normalize_repo_url("https://GitHub.com/acme-scm/release-222/")
        == "https://github.com/acme-scm/release-222"
    )


def test_normalize_repo_url_preserves_path_case() -> None:
    assert (
        normalize_repo_url("https://github.com/Org/MyRepo")
