...
| M015 | native | `play_hosts` magic variable; use `ansible_play_hosts` | — |
| M016 | OPA | Empty `when:` on task is deprecated | — |
| M017 | OPA | `action` key mapping in `tasks_from` deprecated | — |
...
| M028 | OPA | `first_found` auto-split on colon deprecated | — |
